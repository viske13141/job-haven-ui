  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:opacity-90 shadow-elegant hover:shadow-hover hover:scale-105",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-card hover:shadow-hover",
        pending: "bg-pending text-pending-foreground hover:bg-pending/90 shadow-card hover:shadow-hover",
        rejected: "bg-rejected text-rejected-foreground hover:bg-rejected/90 shadow-card hover:shadow-hover",
        premium: "bg-gradient-hero text-primary-foreground hover:opacity-90 shadow-elegant hover:shadow-hover hover:scale-105 animate-pulse-glow",
      },
      size: {
